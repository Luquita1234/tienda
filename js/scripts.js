...
function actualizarCarrito() {
    ...
    carrito.forEach((producto, index) => {
        ...
        botonEliminar.className = 'btn btn-danger btn-sm btncolor';
...
function enviarPorWhatsApp() {
    const numero = '5493484237789'; // Reemplazar con el número de teléfono destino
    let mensaje = 'Hola Luca, me gustaría comprar estos productos:\n';
